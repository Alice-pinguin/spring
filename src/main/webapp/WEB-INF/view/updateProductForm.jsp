...
<body>
    ...
    <form:form method="post" modelAttribute="product" class="form-signin" action="product/update">
        ...
        <form:input type="hidden" path="manufacturer" value="${product.get().manufacturer}"/> <br/>
